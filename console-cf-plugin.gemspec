...
require "console-cf-plugin/version"
...
Gem::Specification.new do |s|
  ...
  s.summary     = %q{
    Port of rails-console to cf-ng.
  }

  s.rubyforge_project = "console-cf-plugin"

  s.files         = %w{Rakefile} + Dir.glob("lib/**/*")
  s.test_files    = Dir.glob("spec/**/*")
  s.require_paths = ["lib"]

  s.add_runtime_dependency "tunnel-cf-plugin", ">= 0.3.0.rc1", "< 0.4"
